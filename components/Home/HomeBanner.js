...
export default function HeroSection() {
  return (
    <>
      <main>
        <section className="relative bg-cover bg-center bg-no-repeat pt-12 lg:pt-4 pb-14 lg:pb-4" style={{ backgroundImage: `url(${HomeBanner.src})` }}>
          ...
          <div className="relative z-10 mx-auto lg:max-w-7xl w-full px-5 sm:px-10 md:px-12 lg:px-5 flex items-center justify-center lg:justify-start">
            ...
            <div className="flex flex-col text-center lg:text-left gap-8 lg:gap-10 xl:gap-12 relative max-w-4xl lg:max-w-none w-full lg:w-1/2">
              <div className="space-y-8 xl:my-12 lg:py-8" style={{
                paddingTop: "1rem",
                paddingBottom: "3rem"
              }}>
                <h1 className="text-green-950 dark:text-white sm:text-2xl md:text-3xl xl:text-4xl font-bold" style={{ color: 'whitesmoke' }}>
                  Global Education Care {" "}
                  <span className="text-transparent bg-clip-text bg-gradient-to-br to-sky-600" style={{ color: 'black' }}>
                    Your
                  </span>{" "}
                  Gateway to Worldwide Learning
                </h1>
