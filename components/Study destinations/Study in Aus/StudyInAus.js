        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            <h2 className="text-3xl font-bold mb-4">
              Studying in Australia is an experience.<br></br>
              Here’s why
            </h2>
            <p className="mb-4">
              Australia isn't just a place to study; it's an adventure waiting
              to happen! From bustling city life to breathtaking landscapes,
              Australia is the perfect spot to learn, grow, and make memories
              that last a lifetime. Ready for the journey?
            </p>
            <h3 className="text-2xl font-bold mb-2">Why study in Australia?</h3>
            <p className="mb-4">
              Here’s{" "}
            ...
            <ol className="list-decimal pl-5 mb-4">
              <li className="mb-2">
                <strong>Student-friendly cities:</strong> Australia is home to
                the most student-friendly cities. According to the QS Best
                Student Cities 2024, 7 of the top 50 student cities are in
                Australia.
              </li>
              <li className="mb-2">
                <strong>World-recognised universities:</strong> Australia is
