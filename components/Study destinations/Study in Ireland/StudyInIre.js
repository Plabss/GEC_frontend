        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            <h2 className="text-3xl font-bold mb-4">
              Studying in Ireland is an experience.<br></br>
              Here’s why
            </h2>
            <p className="mb-4">
              Ireland isn't just a place to study; it's an adventure waiting
              to happen! From bustling city life to breathtaking landscapes,
              Ireland is the perfect spot to learn, grow, and make memories
              that last a lifetime. Ready for the journey?
            </p>
            <h3 className="text-2xl font-bold mb-2">Why study in Ireland?</h3>
            <p className="mb-4">
              Here’s{" "}
