...
import StudyInIre from '@/components/Study destinations/Study in Ireland/StudyInIre'
...
export default function page() {
  ...
  return (
    <div >
        ...
        <StudyInIre></StudyInIre>
        <PopularUniversity country={"Ireland"}></PopularUniversity>
