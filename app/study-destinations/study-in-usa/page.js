...
import StudyInUSA from "@/components/Study destinations/Study in USA/StudyInUSA";
...
export default function page() {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      review:
        "Excellent service, very professional and supportive. Highly recommend!",
      image: one,
    },
    {
      name: "Alice Johnson",
    ...
    },
    {
      ...
      review:
        "Outstanding experience. I would definitely work with them again.",
  ...
  return (
    <div>
      ...
      <PopularUniversity country={"USA"}></PopularUniversity>
